...
/* HAMODEM-1682 reset reason code */
#define DEBUG_CODE_MALLOC_FAIL 0x10000   /* (1 << 16)  */
#define DEBUG_CODE_SW_REBOOT   0x20000   /* (1 << 17)  */
/**
