...
EmberAfAttributeMetadata matter_cluster_bridged_device_basic_information_attributes[] = {
    {ZAP_EMPTY_DEFAULT(), 0x0005, 33, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(SINGLETON) | ZAP_ATTRIBUTE_MASK(WRITABLE)},
    {ZAP_EMPTY_DEFAULT(), 0x0011, 1, ZAP_TYPE(BOOLEAN), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(SINGLETON) | ZAP_ATTRIBUTE_MASK(WRITABLE)},
    {ZAP_SIMPLE_DEFAULT(0), 0xFFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE)},
    {ZAP_SIMPLE_DEFAULT(1), 0xFFFD, 2, ZAP_TYPE(INT16U), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(SINGLETON)},
};
EmberAfCluster matter_cluster_bridged_device_basic_information_server = {
    .clusterId = 0x00000039,
    .attributes = matter_cluster_bridged_device_basic_information_attributes,
    .attributeCount = ArraySize(matter_cluster_bridged_device_basic_information_attributes),
    .clusterSize = 0,
    .mask = ZAP_CLUSTER_MASK(SERVER),
    .functions = NULL,
    .acceptedCommandList = nullptr,
...
constexpr chip::CommandId matter_cluster_administrator_commissioning_accepted_commands[] = {
    0x0000,
    0x0001,
    0x0002,
    kInvalidCommandId,
...
EmberAfCluster matter_cluster_administrator_commissioning_server = {
    ...
    .mask = ZAP_CLUSTER_MASK(SERVER),
    .functions = NULL,
    .acceptedCommandList = matter_cluster_administrator_commissioning_accepted_commands,
    .generatedCommandList = nullptr,
    .eventList = nullptr,
    .eventCount = 0
};
...
EmberAfCluster matter_dimmable_light_clusters[] = {
    ...
    Presets::Clusters::matter_cluster_bridged_device_basic_information_server,
};
