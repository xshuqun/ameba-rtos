...
public:
    ...
    OperationalState::Instance * GetOperationalStateInstance(){return &mOperationalStateInstance;}
...
chip::app::Clusters::ExampleMicrowaveOvenDevice * GetMatterMicrowaveOvenServer();
